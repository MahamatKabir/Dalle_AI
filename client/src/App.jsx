  ...
  return (
    <BrowserRouter>
       <header className="w-full flex justify-between items-center bg-white sm:px-8 px-4 border-b border-b-[#e6ebf4]" >
           ...
           <Link to="/"  className="font-inter font-medium bg-[#238212] text-white px-4 py-2 rounded-md">
            create
           </Link>
       </header>
       <main className='sm:p-8 px-4 py-8  w-full bg-[#f9fafe] min-h-[calc(200vh-73px)]'>
          <Routes>
